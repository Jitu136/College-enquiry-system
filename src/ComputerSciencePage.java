...
public class ComputerSciencePage extends JFrame {
    ...
    private void initComponents() {
        ...
        CS_placement.addActionListener(e -> {
            List<String[]> CSplacement =getCSPlacementData();
            String[] csPlacementFields = {
                    "cs_placement_id",
                    "academic_year",
            ...
            CSplacement.add(0, csPlacementFields);
            TableDisplayPage obj = new TableDisplayPage(CSplacement);
        });
        ...
        CS_FEESSTRUCTURE.addActionListener( e -> {
            List<String[]> CSFeeStructure = getCSFeesStructures();
            String[] csFeesStructureFields = {
                    "cs_fees_structure_id",
                    "category",
                    "tution_fees",
                    "development_fees",
                    "eligibility_fees",
            ...
            CSFeeStructure.add(0, csFeesStructureFields);
            TableDisplayPage obj = new TableDisplayPage(CSFeeStructure);
        });
        ...
        CS_CUTOFF_CAP1.addActionListener(e ->{
            List<String[]>  CS_CUTOFF_CAP1 = getCSPreviousYearCutoffCap1();
            String[] csPreviousYearCutoffCap1Fields = {
                    "cs_serial_id",
                    "category",
                    "marks"
            };
            CS_CUTOFF_CAP1.add(0, csPreviousYearCutoffCap1Fields);
            TableDisplayPage obj = new TableDisplayPage(CS_CUTOFF_CAP1);
        });
        //---- CS_CUTOFF_CAP2 ----
        ...
        CS_CUTOFF_CAP2.addActionListener(e ->{
            List<String[]> CS_CUTOFF_CAP2 = getCSPreviousYearCutoffCap2();
            String[] csPreviousYearCutoffCap2Fields = {
                    "cs_serial_id",
                    "category",
                    "marks"
            };
            CS_CUTOFF_CAP2.add(0, csPreviousYearCutoffCap2Fields);
            TableDisplayPage obj = new TableDisplayPage(CS_CUTOFF_CAP2);
        });
        //---- CS_CUTOFF_CAP3 ----
        ...
        CS_CUTOFF_CAP3.addActionListener(e ->{
            List<String[]> CS_CUTOFF_CAP3 = getCSPreviousYearCutoffCap3();
            String[] csPreviousYearCutoffCap3Fields = {
                    "cs_serial_id",
                    "category",
                    "marks"
            };

            CS_CUTOFF_CAP3.add(0, csPreviousYearCutoffCap3Fields);
            TableDisplayPage obj = new TableDisplayPage(CS_CUTOFF_CAP3);
        });
        //---- label1 ----
